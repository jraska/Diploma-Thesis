...
\minipage{0.32\textwidth}
  ...
  \caption{Fotoaparát}\label{fig:camera}
\endminipage\hfill
\minipage{0.32\textwidth}%
  \centering
  \includegraphics[scale=0.2]{img/recordsound.png}
  \caption{Nahrávání zvuku}\label{fig:recordsound}
\endminipage
\end{figure}
...
vytvořit, nicméně vývojové nástorje již tento scénář předpokládají a tyto astrové verze jsou
