...
\texttt{selectRoutesSync} nyní trvá 130ms, nicméně se tak děje v pracovním vlákně aplikace a uživatel
 tak nezaznamená zaseknutí užovatelského rozhraní při zobrazování obrazovky a po prodlevě načítání
...
Pro pomalé zařízení byl tedy problém se zablokováním uživatelského rozhraní takto vyřešen.
