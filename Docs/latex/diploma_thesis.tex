...
\subsubsection{Základní komponenty aplikace}
\textbf{AndroidManifest.xml} - Jedná se v o výpis všech veřejných informací, které potřebuje systém
a také uživatel o aplikaci vědět. Android manifest obsahuje identifikátor aplikace, deklaruje všechny
požadovaná povolení a podporované velikosti obrazovek zařízení, vyžadované funkce jako například přítomnost
...
jejich spuštění, které se v systému Andorid realizují záměry(\texttt{Intent}).
