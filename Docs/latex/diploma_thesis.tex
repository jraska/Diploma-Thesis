...
s mentálním postižením tyto telefony více než zdatně ovládá a nabízí se tedy možnost pokusit se prostřednictvím
 ...
 změny a úpravy byly v aplikaci provedeny a jaké možnosti vývoje tento typ aplikace dále nabízí.
...
aktuálních knihoven a nástrojů může aplikace posloužit také jako ukázka použití některé z knihoven
