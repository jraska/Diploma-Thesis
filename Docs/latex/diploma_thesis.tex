...
základní informace a jsou označeny vybraným obrázkem pro snažsí orientaci. Uživatel si poklepnutím
na řádek cesty může dostat na její detail případně rychlými akcemi spusti navigaci.

\vspace{0.1cm}
\noindent
\textbf{Spouštěč:} Užvatel klepne na ikonu aplikace v telefonu.
...
nahrávky nebo poznámky. Zkontroluje se podle uožených statistik, zda bude uživateli stačit baterie
...
a snaží se mu napovífat následující směr pomocí zobrazené šipky. Jak se klient pohybuje, aplikace mu
poskytuje nahraný obsah asisitentem, který by mu měl pomoci v danou chvíli se lépe zorientovat.
...
a upozorní uživatele na přitomnost fotky, která se zobrazí na dobu, po kterou je uživatel nablízku.
...
a začne se uživateli přehrávat. Zárove%n se zobrazí popis nahrávky a tlačítko umožňující
...
\vspace{0.1cm}
\noindent
\textbf{Spouštěč:} Uživatel se přiblíži k místu pořízení nahrávky nebo klepne na ikonu nahrávky.
...
vydat. Informace je zobrazena v dolní čáasti obrazovky v podobě jednoduché šípky.
...
asistencí cestování na cetsu zapsanou na tagu.
...
které kontaktují jeho asistenta.
\vspace{0.1cm}
\noindent
...
\vspace{0.1cm}
\noindent
\textbf{Hlavní scénář:} Kientovi se otevře emailová aplikace s nachystanou zprávou a adresou aisstenta
