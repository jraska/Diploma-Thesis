...
\noindent
 ...
 Pro analýzu kódu a odhalování potencionálních chyb, problémů a nepoužívaných souborů je používán Lint,
  což je nástroj, který na projektu kontroluje dodržení sady poskytnutých pravidel a který
...
U některých knihoven je také zdůvodněno, proč jsou používýny a proč by používány být měly,
neboť mnohé řeší velice časté problémy vývoje, příčiny nekvalitního kódu a je na nich založena
